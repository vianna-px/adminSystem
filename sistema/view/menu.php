    ...
    <div class="navbar navbar-inverse navbar-fixed-top" data-spy="affix" data-offset-top="100">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="inicio.php"><img class="img-responsive logo img-thumbnail" src="../img/logo_VIPAX.png" alt="" width="200px" height="150px"></a>
        </div>
        <div id="navbar" class="collapse navbar-collapse">
          ...
          <li class="dropdown" >
            ...
            <ul class="dropdown-menu">
              ...
              <li> <a style="color: black" href="usuarios.php"><span class="glyphicon glyphicon-list"></span> Gestão de Usuários</a></li>
              <?php endif ?>
